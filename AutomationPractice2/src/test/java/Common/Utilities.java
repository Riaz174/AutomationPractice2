...
public class Utilities {
  ...
  public void Browsers(String browsers, String Wbsite) {
	   if(browsers.equalsIgnoreCase("Chrome")) {
		   ...
		   System.setProperty("webdriver.edge.driver", "C:\\Users\\riaz_\\git\\repository4\\AutomationPractice2\\src\\Drivers\\msedgedriver.exe");
		  	driver = new EdgeDriver();
		  	driver.navigate().to(Wbsite);
			  driver.manage().window().maximize();
	   
	   }else {
		   System.out.println("Correct browser's name");
  ...
  public void shots() throws IOException{
	   ...
	   File ks =((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		org.openqa.selenium.io.FileHandler.copy(ks, new File("C:\\Users\\riaz_\\git\\repository4\\AutomationPractice2\\Pictures\\"+sd+"pictureofwebsite.jpg"));
